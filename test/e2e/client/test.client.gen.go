...
// CustomTestClient which conforms to the OpenAPI3 specification for this service.
type CustomTestClient struct {
...
type ClientOption func(*CustomTestClient) error

// Creates a new CustomTestClient, with reasonable defaults
func NewClient(server string, opts ...ClientOption) (*CustomTestClient, error) {
...
func WithHTTPClient(doer HttpRequestDoer) ClientOption {
	return func(c *CustomTestClient) error {
		c.Client = doer
		return nil
	}
}
...
func (c *CustomTestClient) PostApiAuthWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *CustomTestClient) PostApiAuth(ctx context.Context, body PostApiAuthJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *CustomTestClient) GetApiBuyItem(ctx context.Context, item string, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *CustomTestClient) GetApiInfo(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *CustomTestClient) PostApiSendCoinWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *CustomTestClient) PostApiSendCoin(ctx context.Context, body PostApiSendCoinJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *CustomTestClient) applyEditors(ctx context.Context, req *http.Request, additionalEditors []RequestEditorFn) error {
